...
open class ReadUncommitedTests(
    ...
    fun `reading in T1, inserting and updating in T2, reading in T1 again`() {
        ...
        try {
            ...
            conn2.prepareStatement("update items set quantity = quantity - 1 where id = 1 and store_id = 1").executeUpdate()
            ...
            conn1.prepareStatement("update items set quantity = quantity - 1 where id = 1 and store_id = 1").executeUpdate()
            conn1.commit()
